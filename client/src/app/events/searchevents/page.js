...
//             return(<div> No similar results found</div>)
//         }
//      if(res.code ==1){
...
//   <h1 className="text-5xl text-transparent underline  text-center  mt-0 bg-gradient-to-br from-deepNavy via-accent to-softPink bg-clip-text">Search Results:</h1>
...
const SearchEventsPage = () => {
  ...
  return (
    <section className="min-h-screen px-4  bg-base">
      ...
      {noResults ? (
        <div className="text-center text-gray-500 mt-10 text-lg">No similar results found</div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 bg-base">
          {events.map((event) => (
            <Card
