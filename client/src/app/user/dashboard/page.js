...
return(
 <>
  <h1 className="text-5xl text-transparent underline  text-center  mt-5 bg-gradient-to-br from-deepNavy via-accent to-softPink bg-clip-text">Bookmarked Events</h1>
