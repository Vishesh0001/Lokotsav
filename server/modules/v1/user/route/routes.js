...
router.get('/totalevents',userController.totalEvents)
router.get('/totalfeatured',userController.totalfeaturedevents)
router.get('/totalticketssold',userController.totalTicketssold)
